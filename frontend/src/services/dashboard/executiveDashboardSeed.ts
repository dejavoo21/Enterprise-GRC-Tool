...
const FRAMEWORK_SEED_ROWS: ExecutiveFrameworkCoverageSeed[] = [
  ...
  { framework: 'HITRUST CSF', coverage: 81, controlsMapped: 18, complianceScore: 82, tone: 'success' },
  { framework: 'ISO 27001', coverage: 88, controlsMapped: 34, complianceScore: 88, tone: 'success' },
  { framework: 'ISO 27701', coverage: 75, controlsMapped: 15, complianceScore: 76, tone: 'warning' },
  { framework: 'ISO 42001 (AI)', coverage: 74, controlsMapped: 13, complianceScore: 74, tone: 'warning' },
  { framework: 'NIST 800-53', coverage: 83, controlsMapped: 22, complianceScore: 84, tone: 'success' },
  { framework: 'NIST CSF', coverage: 82, controlsMapped: 20, complianceScore: 82, tone: 'success' },
  { framework: 'NIS2', coverage: 72, controlsMapped: 14, complianceScore: 73, tone: 'warning' },
  { framework: 'PCI DSS', coverage: 83, controlsMapped: 21, complianceScore: 83, tone: 'success' },
  { framework: 'SOC 1', coverage: 73, controlsMapped: 10, complianceScore: 74, tone: 'warning' },
  { framework: 'SOC 2', coverage: 85, controlsMapped: 24, complianceScore: 86, tone: 'success' },
];
