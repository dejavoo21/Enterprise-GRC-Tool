...
export const workspaceDefinitions: WorkspaceDefinition[] = [
  {
    ...
    routeKey: 'executive-overview',
    routePath: '/workspaces/executive',
    railIcon: <DashboardIcon size={18} />,
    accent: 'var(--color-primary)',
    allowedRoles: ['owner', 'admin', 'grc', 'auditor', 'viewer'],
    items: [
      { key: 'executive-overview', label: 'Overview', description: 'Real-time enterprise posture and operational overview.', icon: <DashboardIcon size={18} /> },
      { key: 'dashboard', label: 'Executive Dashboard', description: 'Balanced executive command view.', icon: <DashboardIcon size={18} /> },
      { key: 'executive-workspace', label: 'Board Intelligence', description: 'Executive center and board signals.', icon: <ReportsIcon size={18} /> },
